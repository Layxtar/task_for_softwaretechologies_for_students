...
public final class Elevator {
     ...
     */
    public void goToExactFloor(int floor) {
        // Проверяем, находится ли указанный этаж в пределах допустимого диапазона
        if (floor < lowestFloor || floor > highestFloor) {
            System.out.println("Указан неверный этаж");
            return;
        }

        // Перемещаем лифт этаж за этажом до достижения указанного этажа
        ...
        // Сообщаем о достижении указанного этажа
